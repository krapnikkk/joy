...
export default class Treasurehunt extends React.Component<IProps, IState, {}> {
    ...
    public async componentDidMount() {
        ...
        injectCustomJs("assets/smashUtils.js");
    }
                ...
                <PageHeader
                    ...
                    extra={[
                        <Button key="1" type={'primary'} onClick={() => {
                            openWindow("https://wbbny.m.jd.com/babelDiy/Zeus/3rFiv8Sdkn7BPhk8Pw8xrgMWH6mT/index.html")
                        }}>跳转活动</Button>,
                    ]}
                ></PageHeader>
                <Content>
    ...
    async raise() {
        for (let i = 0; i < this.state.accountInfo.length; i++) {
            ...
            if (success) {
                ...
                // log = `打卡成功！获得金币：${score} 当前金币：${+totalScore - (+usedScore)}`;
                // if (type == 4) {
    ...
    async getSourceRes(cookie: string, args?: {}) {
        ...
        let body = {
            ...args,
            random,
            log: window['smashUtils'].get_risk_result({data:{random},id: "coupon_receive"}).log
        }
